...
class SetThemeUseCase(private val repo: ISettingsRepository) {
    suspend operator fun invoke(isDark: Boolean): TResult<Unit, MovieExceptionDomainModel> = repo.setTheme(isDark)
}